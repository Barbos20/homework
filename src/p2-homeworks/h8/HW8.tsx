...
function HW8() {
  ...
  return (
    <div>
      ...
      {finalPeople}
      <div>
        <SuperButton onClick={sortUp} className={s.Btn}>sort up</SuperButton>
        <SuperButton onClick={sortDown} className={s.Btn}>sort down</SuperButton>
        <SuperButton onClick={check18} className={s.Btn}>check18</SuperButton>
      </div>
      <hr />
